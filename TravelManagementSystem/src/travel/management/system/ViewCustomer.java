...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username){
        ...
        ImageIcon i = new ImageIcon(ClassLoader.getSystemResource("images/viewall.jpg"));
        Image i2 = i.getImage().getScaledInstance(600, 200, Image.SCALE_DEFAULT);
        ...
        Image i4 = i1.getImage().getScaledInstance(600, 200, Image.SCALE_DEFAULT);
